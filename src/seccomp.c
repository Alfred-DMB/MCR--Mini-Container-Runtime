...
// -------------------------------------------------------
// FILTRO COMPLETO (syscalls necesarias para shell)
// -------------------------------------------------------
static struct sock_filter filtro[] = {
    ...
    ALLOW_SYSCALL(__NR_chown),
    ALLOW_SYSCALL(__NR_fchown),
    ALLOW_SYSCALL(__NR_lchown),
...
// FUNCIÓN PRINCIPAL
// -------------------------------------------------------
int cargar_filtro_seccomp(void) {
